...
suite('Unit Tests', function () {
  ...
  suite('Objects', function () {
    ...
    test('#instanceOf, #notInstanceOf', function () {
      ...
      assert.notInstanceOf(myCar.wheels, String);//como en javascript puedo no definir el tipo al hacer la estructura/objeto, necesito construir el tipo directamente en el nuevo objeto si quiero usar instanceOf correctamente: new String("cadena") instanceOf String
    });
  });
